                ...
                nextMove.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent actionEvent) {
                        ...
                        switch (clickCount) {
                            ...
                            case 2:
                                instructions.setText("Black responds with pawn to d5, trying to block the white pawn and control the center");
                                squares[6][4].setText("");
                                squares[4][4].setText("♟");
                                break;

                            case 3:
                                instructions.setText("White pushes pawn c4, trying to sacrifice a pawn for central control and setup e4");
                                squares[3][1].setText("");
                                squares[3][5].setText("♙");
                                break;

                            case 4:
                                instructions.setText("Black responds by defending the central position and not giving into the gambit");
                                squares[6][5].setText("");
                                squares[5][5].setText("♟");

                            case 5:
                                instructions.setText("You completed the Slav Defense!");
                            default:
